...
*/
    ...
    @Query("SELECT id, bulkItemId, productName, itemCode, epc, imageUrl, isScanned, counterName, branchName, boxName, branchType, totalQty, totalNetWt, mrp, categoryId,category, rfid, design ,grossWeight,netWeight,stoneWeight,diamondWeight ,makingPerGram,fixMaking,fixWastage,stoneAmount,diamondAmount,sku ,purity FROM bulk_items ORDER BY bulkItemId LIMIT :limit OFFSET :offset")
